...
export class ResumeBuilderUiComponent implements OnInit {
  ...
  public runFirst() {
    ...
    if (this.cvUserData.techskill) {
      this.techskill = this.cvUserData.techskill;
    }
    if (this.cvUserData.education) {
      this.educations = this.cvUserData.education;
    }
    if (this.cvUserData.workExperiences) {
      this.workExperiences = this.cvUserData.workExperiences;
    }
    if (this.cvUserData.professionalSummaries) {
      this.professionalSummaries = this.cvUserData.professionalSummaries;
    }

    if (this.cvUserData.certifications) {
      this.certifications = this.cvUserData.certifications;
    }
  ...
  // removing fields
  public removeSkill(i: any) {

    this.techskill.splice(i, 1);
